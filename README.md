...
```
---------------------------------------------------------------------------------------------------------
Usage: CloudPhotoMigrator.run/exe [-h] [-v] [-i <INPUT_FOLDER>] [-o <OUTPUT_FOLDER>] [-nolog]
                                  [-AUTO <SOURCE> <TARGET>]
                                  ...
                                  [-sdea] [-sdda] [-suFld <INPUT_FOLDER>]
                                  [-suAlb <ALBUMS_FOLDER>]
                                  [-sdAlb <ALBUMS_NAME> [<ALBUMS_NAME> ...]]
                                  [-suAll <INPUT_FOLDER>] [-sdAll <OUTPUT_FOLDER>]
                                  [-idea] [-idda] [-iuFld <INPUT_FOLDER>]
                                  [-iuAlb <ALBUMS_FOLDER>]
                                  [-idAlb <ALBUMS_NAME> [<ALBUMS_NAME> ...]]
                                  [-iuAll <INPUT_FOLDER>] [-idAll <OUTPUT_FOLDER>] [-idoa]
                                  [-ideAll] [-ideAlb] [-iiaa]
...
-AUTO,   --AUTOMATED-MIGRATION ('<SOURCE>', '<TARGET>')
           ...
           Assets (including Albums) from the <SOURCE> Cloud Service and Upload them to
...
-gofs,   --google-output-folder-suFldfix <SUFIX>
...
-sdAlb,  --synology-download-albums <ALBUMS_NAME>
           The Script will connect to Synology Photos and download the Album whose name
           is '<ALBUMS_NAME>' to the folder 'Download_Synology' within the Synology
           Photos root folder.
...
-suAll,  --synology-upload-all <INPUT_FOLDER>
           ...
           inside each subfolder of 'Albums' willl be associated to a new Album in
           Synology Photos with the same name as the subfolder
...
-iuAll,  --immich-upload-all <INPUT_FOLDER>
           ...
           - If the <INPUT_FOLDER> contains a Subfolder called 'Albums' then, all assets
           inside each subfolder of 'Albums' willl be associated to a new Album in
           Immich Photos with the same name as the subfolder
...
-ideAlb, --immich-delete-all-albums
           ...
           include the argument '-iiaa, --immich-include-albums-assets' argument.
-iiaa,   --immich-include-albums-assets
...
-fdup,   --find-duplicates <ACTION> <DUPLICATES_FOLDER> [<DUPLICATES_FOLDER> ...]
           ...
           script will look for duplicates files. The order of this list is important to
