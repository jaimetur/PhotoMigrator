...
- [**Synology Photos Management**](/help/4-synology-photos.md) - Features included:
  - Upload Album(s) (from folder) [(help)](/help/4-synology-photos.md#upload-albums-from-local-folder-into-synology-photos)
  - Download Album(s) (into folder) [(help)](/help/4-synology-photos.md#download-albums-from-synology-photos)
  - Upload ALL (from folder) [(help)](/help/4-synology-photos.md#upload-all-from-local-folder-into-synology-photos)
  - Download ALL (into folder) [(help)](/help/4-synology-photos.md#download-all-from-synology-photos)
  - Remove ALL Assets [(help)](/help/4-synology-photos.md#remove-all-assets-from-synology-photos)
  - Remove ALL Albums [(help)](/help/4-synology-photos.md#remove-all-albums-from-synology-photos)
  - Remove Albums by Name Pattern [(help)](/help/4-synology-photos.md#remove-albums-by-name-pattern-from-synology-photos)
  - Rename Albums by Name Pattern [(help)](/help/4-synology-photos.md#rename-albums-by-name-pattern-from-synology-photos)
  - Remove Empty Albums [(help)](/help/4-synology-photos.md#remove-empty-albums-from-synology-photos)
  - Remove Duplicates Albums [(help)](/help/4-synology-photos.md#remove-duplicates-albums-from-synology-photos)
  - Merge Duplicates Albums [(help)](/help/4-synology-photos.md#merge-duplicates-albums-from-synology-photos)

- [**Immich Photos Management**](/help/5-immich-photos.md) - Features included:
  - Upload Album(s) (from folder) [(help)](/help/5-immich-photos.md#upload-albums-from-local-folder-into-immich-photos)
  - Download Album(s) (into folder) [(help)](/help/5-immich-photos.md#download-albums-from-immich-photos)
  - Upload ALL (from folder) [(help)](/help/5-immich-photos.md#upload-all-from-local-folder-into-immich-photos)
  - Download ALL (into folder) [(help)](/help/5-immich-photos.md#download-all-from-immich-photos)
  - Remove ALL Assets [(help)](/help/5-immich-photos.md#remove-all-assets-from-immich-photos)
  - Remove ALL Albums [(help)](/help/5-immich-photos.md#remove-all-albums-from-immich-photos)
  - Remove Albums by Name Pattern [(help)](/help/5-immich-photos.md#remove-albums-by-name-pattern-from-immich-photos)
  - Rename Albums by Name Pattern [(help)](/help/5-immich-photos.md#rename-albums-by-name-pattern-from-immich-photos)
  - Remove Empty Albums [(help)](/help/5-immich-photos.md#remove-empty-albums-from-immich-photos)
  - Remove Duplicates Albums [(help)](/help/5-immich-photos.md#remove-duplicates-albums-from-immich-photos)
  - Merge Duplicates Albums [(help)](/help/5-immich-photos.md#merge-duplicates-albums-from-immich-photos)
  - Remove Orphans Assets [(help)](/help/5-immich-photos.md#remove-orphans-assets-from-immich-photos)
