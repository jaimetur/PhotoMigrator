...
[![Pre-release version downloads](https://img.shields.io/github/downloads/jaimetur/PhotoMigrator/v4.7.0/total?label=Pre%20version%20downloads)](https://github.com/jaimetur/PhotoMigrator/releases?q=prerelease%3Atrue)
...
> [!TIP]
> For Local Photos Folder migrations and uploads, you can exclude generated thumbnails or other unwanted content using glob patterns with `--exclude-folders` and `--exclude-files`.
>
> Example:
...
## 🖼️ 4. Google Photos / Synology Photos / Immich Photos / NextCloud Photos / Local Photos Folder
Apart from the `Automatic Migration`, `Google Takeout Fixing`, and `iCloud Takeout Fixing` features, you can also use the tool to manage Google Photos, photo cloud services, and managed local photo libraries.
...
- **Local Photos Folder** provides the same library-management modules against a managed on-disk library, using `No_Albums` for physical media and `Albums` for album membership links.

Currently, the features supported by each service are:

  | Feature                         | Google Photos                                                               | Synology Photos                                                                        | Immich Photos                                                                      | Nextcloud Photos                                                                         | Local Photos Folder                                                                            |
  |---------------------------------|-----------------------------------------------------------------------------|----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
  | Upload Album(s) (from folder)   | [doc](help/06-google-photos.md#upload-albums)                               | [doc](help/07-synology-photos.md#upload-albums-from-local-folder-into-synology-photos) | [doc](help/08-immich-photos.md#upload-albums-from-local-folder-into-immich-photos) | [doc](help/09-nextcloud-photos.md#upload-albums-from-local-folder-into-nextcloud-photos) | [doc](help/10-local-photos-folder.md#upload-albums-from-local-folder-into-local-photos-folder) |
  | Download Album(s) (into folder) | [doc](help/06-google-photos.md#download-albums)                             | [doc](help/07-synology-photos.md#download-albums-from-synology-photos)                 | [doc](help/08-immich-photos.md#download-albums-from-immich-photos)                 | [doc](help/09-nextcloud-photos.md#download-albums-from-nextcloud-photos)                 | [doc](help/10-local-photos-folder.md#download-albums-from-local-photos-folder)                 |
  | Upload ALL (from folder)        | [doc](help/06-google-photos.md#upload-all)                                  | [doc](help/07-synology-photos.md#upload-all-from-local-folder-into-synology-photos)    | [doc](help/08-immich-photos.md#upload-all-from-local-folder-into-immich-photos)    | [doc](help/09-nextcloud-photos.md#upload-all-from-local-folder-into-nextcloud-photos)    | [doc](help/10-local-photos-folder.md#upload-all-from-local-folder-into-local-photos-folder)    |
  | Download ALL (into folder)      | [doc](help/06-google-photos.md#download-all)                                | [doc](help/07-synology-photos.md#download-all-from-synology-photos)                    | [doc](help/08-immich-photos.md#download-all-from-immich-photos)                    | [doc](help/09-nextcloud-photos.md#download-all-from-nextcloud-photos)                    | [doc](help/10-local-photos-folder.md#download-all-from-local-photos-folder)                    |
  | Remove ALL Assets               | Not supported by API                                                        | [doc](help/07-synology-photos.md#remove-all-assets-from-synology-photos)               | [doc](help/08-immich-photos.md#remove-all-assets-from-immich-photos)               | [doc](help/09-nextcloud-photos.md#remove-all-assets-from-nextcloud-photos)               | [doc](help/10-local-photos-folder.md#remove-all-assets-from-local-photos-folder)               |
  | Remove ALL Albums               | Not supported by API                                                        | [doc](help/07-synology-photos.md#remove-all-albums-from-synology-photos)               | [doc](help/08-immich-photos.md#remove-all-albums-from-immich-photos)               | [doc](help/09-nextcloud-photos.md#remove-all-albums-from-nextcloud-photos)               | [doc](help/10-local-photos-folder.md#remove-all-albums-from-local-photos-folder)               |
  | Remove Albums by Name Pattern   | Not supported by API                                                        | [doc](help/07-synology-photos.md#remove-albums-by-name-pattern-from-synology-photos)   | [doc](help/08-immich-photos.md#remove-albums-by-name-pattern-from-immich-photos)   | [doc](help/09-nextcloud-photos.md#remove-albums-by-name-pattern-from-nextcloud-photos)   | [doc](help/10-local-photos-folder.md#remove-albums-by-name-pattern-from-local-photos-folder)   |
  | Rename Albums by Name Pattern   | Not supported by API                                                        | [doc](help/07-synology-photos.md#rename-albums-by-name-pattern-from-synology-photos)   | [doc](help/08-immich-photos.md#rename-albums-by-name-pattern-from-immich-photos)   | [doc](help/09-nextcloud-photos.md#rename-albums-by-name-pattern-from-nextcloud-photos)   | [doc](help/10-local-photos-folder.md#rename-albums-by-name-pattern-from-local-photos-folder)   |
  | Consolidate Albums Names        | [doc](help/06-google-photos.md#consolidate-albums-names-from-google-photos) | [doc](help/07-synology-photos.md#consolidate-albums-names-from-synology-photos)        | [doc](help/08-immich-photos.md#consolidate-albums-names-from-immich-photos)        | [doc](help/09-nextcloud-photos.md#consolidate-albums-names-from-nextcloud-photos)        | [doc](help/10-local-photos-folder.md#consolidate-albums-names-from-local-photos-folder)        |
  | Remove Empty Albums             | Not supported by API                                                        | [doc](help/07-synology-photos.md#remove-empty-albums-from-synology-photos)             | [doc](help/08-immich-photos.md#remove-empty-albums-from-immich-photos)             | [doc](help/09-nextcloud-photos.md#remove-empty-albums-from-nextcloud-photos)             | [doc](help/10-local-photos-folder.md#remove-empty-albums-from-local-photos-folder)             |
  | Remove Duplicates Albums        | Not supported by API                                                        | [doc](help/07-synology-photos.md#remove-duplicates-albums-from-synology-photos)        | [doc](help/08-immich-photos.md#remove-duplicates-albums-from-immich-photos)        | [doc](help/09-nextcloud-photos.md#remove-duplicates-albums-from-nextcloud-photos)        | [doc](help/10-local-photos-folder.md#remove-duplicates-albums-from-local-photos-folder)        |
  | Remove Duplicates Assets        | API deletion unavailable                                                    | [doc](help/07-synology-photos.md#remove-duplicates-assets-from-synology-photos)        | [doc](help/08-immich-photos.md#remove-duplicates-assets-from-immich-photos)        | [doc](help/09-nextcloud-photos.md#remove-duplicates-assets-from-nextcloud-photos)        | [doc](help/10-local-photos-folder.md#remove-duplicates-assets-from-local-photos-folder)        |
  | Merge Duplicates Albums         | Not supported by API                                                        | [doc](help/07-synology-photos.md#merge-duplicates-albums-from-synology-photos)         | [doc](help/08-immich-photos.md#merge-duplicates-albums-from-immich-photos)         | [doc](help/09-nextcloud-photos.md#merge-duplicates-albums-from-nextcloud-photos)         | [doc](help/10-local-photos-folder.md#merge-duplicates-albums-from-local-photos-folder)         |
...
>
>- [**(Local Photos Folder Documentation)**](help/10-local-photos-folder.md)
...
- Automatic Migration and Local Photos Folder workflows support exclusion filters for unwanted folders/files such as `@eaDir`, `.@__thumb`, `@Recycle`, `SYNOFILE_THUMB*`, `SYNOPHOTO_THUMB*`, `SYNOVIDEO_THUMB*`, `SYNOPHOTO_FILM*`, `Thumbs.db`, `ehthumbs.db`, `.DS_Store`, or `._*`.
...
## 🪟 2. Graphical User Interface (GUI) and Textual User Interface (TUI)
