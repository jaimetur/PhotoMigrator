...
EXPECTED_SIGNATURES = {
    ...
    "get_album_assets_size": ["self", "album_id", "album_name", "type", "album_passphrase", "album_scope", "log_level"],
    "get_album_assets_count": ["self", "album_id", "album_name", "type", "album_passphrase", "album_scope", "log_level"],
    "album_exists": ["self", "album_name", "shared", "log_level"],
    "get_assets_by_filters": ["self", "type", "is_not_in_album", "is_archived", "with_deleted", "log_level"],
    ...
    "push_albums": ["self", "input_folder", "subfolders_exclusion", "subfolders_inclusion", "remove_duplicates", "log_level"],
    "push_no_albums": ["self", "input_folder", "subfolders_exclusion", "subfolders_inclusion", "remove_duplicates", "log_level"],
    "push_all": ["self", "input_folder", "album_folders", "remove_duplicates", "log_level"],
    "pull_albums": ["self", "album_names", "output_folder", "log_level"],
    "pull_no_albums": ["self", "output_folder", "log_level"],
    "pull_all": ["self", "output_folder", "log_level"],
    "remove_all_albums": ["self", "remove_album_assets", "request_user_confirmation", "log_level"],
    "remove_empty_albums": ["self", "log_level"],
    "remove_duplicates_albums": ["self", "request_user_confirmation", "log_level"],
    "merge_duplicates_albums": ["self", "strategy", "request_user_confirmation", "log_level"],
    "remove_all_assets": ["self", "log_level"],
}
