...
#### 🚀 Enhancements:
  ...
  - Simplified Immich duplicate-review labels by reading the person names and tag values embedded in Immich's duplicate `AssetResponseDto` records, avoiding separate global name-map requests while retaining human-readable preview metadata.
