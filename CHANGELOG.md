...
#### 🚀 Enhancements:
  ...
  - Accelerated Immich `Remove Duplicate Assets` inventory scans by requesting 5,000 metadata assets per page instead of 1,000. Immich paginates this endpoint with offsets, so fewer larger pages avoid most of the increasing skip cost on later pages; servers that reject the larger page size automatically retry with 1,000-asset pages.
