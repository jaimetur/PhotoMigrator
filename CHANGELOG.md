...
- #### 🐛 Bug fixes:
    ...
    - [x] Fixed a bug [#649](https://github.com/jaimetur/PhotoMigrator/issues/649) in get_file_date function affecting files with EXIF tags in different format (UTC naive and UTC aware). Now all EXIF date tags are converted to UTC aware before extracting the oldest date.
