...
#### 🚀 Enhancements:
  ...
  - Improved the `Remove Albums` pre-deletion review across Immich Photos, Synology Photos, NextCloud Photos, and Local Photos Folder. Matching albums are now rendered as an INFO table with an ordinal, name, creation date, asset count, and whether their assets will also be removed, replacing the previous per-album warning list.
