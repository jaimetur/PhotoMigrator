...
- ### Main Changes:
  ...
  - #### 📚 Documentation:
    ...
    - [x] Included CONTRIBUTING.md
    - [x] Included CODE_OF_CONDUCT.md
    - [x] Moved CHANGELOG.md, ROADMAP.md, DOWNLOADS.md, README.md, CONTRIBUTING.md and CODE_OF_CONDUCT.md to the root of the repository for more visibility.
