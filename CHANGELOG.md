...
#### 🚀 Enhancements:
  ...
  - Added post-confirmation progress feedback to Immich `Remove Duplicate Assets`: manual cleanup reports group-by-group resolution, while native resolution reports duplicate-group preparation and real server-side resolution progress.
