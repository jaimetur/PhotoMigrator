...
#### 🚀 Enhancements:
  ...
  - Raised the bounded Immich duplicate-review metadata hydration pool from 24 to 48 asset workers. The manual merge now also matches Immich's location rule: coordinates are copied only when every geotagged asset in the group has the same latitude and longitude.
