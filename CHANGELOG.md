...
#### 🚀 Enhancements:
  ...
  - Improved Automatic Migration ETA stability. Remaining time now uses a five-minute moving average and waits for a representative calibration sample before showing a projection, while preserving the existing Pull-based progress unit. Fixes #1214.
