...
#### 🚀 Enhancements:
  ...
  - Extended the shared valid-photo extension set so `.webp` files (for example `IMG_20210805_112248_719.webp`) and `.MP` files (for example `PXL_20230512_222825532.MP`) are now treated as supported photo/image assets consistently across the local-folder and Synology-backed workflows instead of being classified as unknown/unsupported files.
