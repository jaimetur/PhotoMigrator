...
#### 🚀 Enhancements:
  ...
  - Added bounded retry handling for transient Immich stack-merge connection failures during manual duplicate cleanup. A reset or timeout now retries the stack read/write up to three times with short backoff before the duplicate group is skipped.
