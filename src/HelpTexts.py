def set_help_texts():
    ...
    ###################################
    HELP_TEXTS["HELP_MODE_AUTOMATED_MIGRATION"] = textwrap.dedent(f"""
    ...
    ################################
    HELP_TEXTS["HELP_MODE_GOOGLE_TAKEOUT"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_SYNOLOGY_DELETE_EMPTY_ALBUMS"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_SYNOLOGY_DELETE_DUPLICATES_ALBUMS"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_SYNOLOGY_UPLOAD_FOLDER"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_SYNOLOGY_UPLOAD_ALBUMS"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_SYNOLOGY_UPLOAD_ALL"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_SYNOLOGY_DOWNLOAD_ALBUMS"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_SYNOLOGY_DOWNLOAD_ALL"] = textwrap.dedent(f"""
    ...
    ##############################
    HELP_TEXTS["HELP_MODE_IMMICH_DELETE_EMPTY_ALBUMS"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_IMMICH_DELETE_DUPLICATES_ALBUMS"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_IMMICH_UPLOAD_FOLDER"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_IMMICH_UPLOAD_ALBUMS"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_IMMICH_UPLOAD_ALL"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_IMMICH_DOWNLOAD_ALBUMS"]  = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_IMMICH_DOWNLOAD_ALL"]  = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_IMMICH_DELETE_ORPHAN_ASSETS"]  = textwrap.dedent(f"""
    ...
    ##############################
    HELP_TEXTS["HELP_MODE_FIX_SYMLINKS"] = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_FIND_DUPLICATES"]  = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_PROCESS_DUPLICATES"]  = textwrap.dedent(f"""
    ...
    HELP_TEXTS["HELP_MODE_RENAME_ALBUMS_FOLDERS"]  = textwrap.dedent(f"""
