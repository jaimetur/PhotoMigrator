...
def mode_google_takeout(user_confirmation=True, log_level=logging.INFO):
    ...
    with set_log_level(LOGGER, log_level):  # Change Log Level to log_level for this function
        ...
        # Call the Function
        result = takeout.process(output_takeout_folder=OUTPUT_TAKEOUT_FOLDER, capture_output=ARGS['show-gpth-info'], capture_errors=ARGS['show-gpth-errors'], create_localfolder_object=False, log_level=log_level)
