...
from photomigrator.Core.ChangeWorkingDir import change_working_dir
change_working_dir(change_dir=True)


import photomigrator.Core.GlobalVariables as GV
import importlib
print("")
print ("Loading Tool...")
...
from photomigrator.Core.Utils import check_OS_and_Terminal
from photomigrator.Core.GlobalVariables import LOGGER, ARGS, SCRIPT_DESCRIPTION, LOG_FOLDER_FILENAME, SCRIPT_NAME
from photomigrator.Core.ExecutionModes import detect_and_run_execution_mode
from photomigrator.Core.CustomLogger import print_verbose, print_debug, print_info, print_warning, print_critical
