...
import GoogleTakeoutPrechecks
from photomigrator.Core import GlobalVariables as GV, Utils, ChangeWorkingDir
import traceback
from photomigrator.Core.GlobalVariables import LOGGER, ARGS, TIMESTAMP, HELP_TEXTS, SCRIPT_VERSION, SCRIPT_NAME_VERSION
from photomigrator.Core.GlobalFunctions import resolve_path
from photomigrator.Core.CustomLogger import set_log_level, CustomInMemoryLogHandler, CustomConsoleFormatter, get_logger_filename
    ...
    with set_log_level(LOGGER, log_level):
        ...
        def get_client_object(client_type):
            ...
            # Return ClassTakeoutFolder
                    ...
                    Utils.contains_zip_files(client_type, log_level=logging.WARNING) or GoogleTakeoutPrechecks.contains_takeout_structure(client_type, log_level=logging.WARNING)):
