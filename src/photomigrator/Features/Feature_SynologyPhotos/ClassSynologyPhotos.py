...
from photomigrator.Core.Utils import update_metadata, convert_to_list, get_unique_items, tqdm, match_pattern, replace_pattern, has_any_filter, is_date_outside_range, confirm_continue
from photomigrator.Core.DateFunctions import parse_text_datetime_to_epoch
...
from photomigrator.Core.GlobalVariables import LOGGER, ARGS
...
class ClassSynologyPhotos:
    ...
    def read_config_file(self, config_file='Config.ini', log_level=None):
        ...
        """
        from photomigrator.Core.ConfigReader import load_config
