...
def parse_arguments():
    ...
    # -------------------------------
    PARSER.add_argument("-uAlb", "--upload-albums", metavar="<ALBUMS_FOLDER>", default=None,
    ...
    PARSER.add_argument("-dAlb", "--download-albums", metavar="<ALBUMS_NAME>", nargs="+", default=None,
    ...
    PARSER.add_argument("-uAll", "--upload-all", metavar="<INPUT_FOLDER>", default=None,
    ...
    PARSER.add_argument("-dAll", "--download-all", metavar="<OUTPUT_FOLDER>", default=None,
    ...
    PARSER.add_argument("-rOrphan", "--remove-orphan-assets", action="store_true", default=None,
    ...
    PARSER.add_argument("-rAll", "--remove-all-assets", action="store_true", default=None,
                        help="CAUTION!!! The Tool will remove ALL your Assets (Photos & Videos) and also ALL your Albums from the selected Photo client.")
    PARSER.add_argument("-rAllAlb", "--remove-all-albums", action="store_true", default=None,
    ...
    PARSER.add_argument("-rAlb", "--remove-albums", metavar="<ALBUMS_NAME_PATTERN>", default=None,
    ...
    PARSER.add_argument("-rEmpAlb", "--remove-empty-albums", action="store_true", default=None,
    ...
    PARSER.add_argument("-rDupAlb", "--remove-duplicates-albums", action="store_true", default=None,
    ...
    PARSER.add_argument("-mDupAlb", "--merge-duplicates-albums", action="store_true", default=None,
    ...
    PARSER.add_argument("-renAlb", "--rename-albums", metavar="<ALBUMS_NAME_PATTERN>, <ALBUMS_NAME_REPLACEMENT_PATTERN>", nargs="+", default=None,
