...
from Utils.GeneralUtils import update_metadata, convert_to_list, tqdm, match_pattern, replace_pattern, has_any_filter, confirm_continue, sha1_checksum, find_reusable_album_candidate, build_reusable_album_group
                    ...
                    for subpath in valid_folders:
                        ...
                        if album_assets_ids:
                            ...
                            if ambiguous_matches:
                                ...
                                LOGGER.warning(
                                    f"Found multiple similar existing Immich albums for '{album_name}' "
                            ...
                            if matched_album:
                                ...
                                if match_kind == "similar" and matched_name != album_name:
                                    LOGGER.info(
                                        f"Reusing similar existing Immich album '{matched_name}' "
