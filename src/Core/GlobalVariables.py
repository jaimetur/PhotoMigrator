...
TOOL_VERSION_WITHOUT_V          = "4.6.0"
TOOL_VERSION                    = f"v{TOOL_VERSION_WITHOUT_V}"
TOOL_DATE                       = "2026-07-21"
...
FOLDERNAME_NO_ALBUMS            = "No_Albums"                                   # To be Changed in set_GLOBAL_VARIABLES
FOLDERNAME_ALL_PHOTOS           = "ALL_PHOTOS"                                  # Takeout master library folder
