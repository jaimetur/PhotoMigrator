...
def include_extrafiles_and_zip(input_file, output_file):
    extra_files_to_subdir = [
        ...
        {
            'subdir': 'assets',# Estos ficheros van al subdirectorio 'assets'
            'files': ["../README.md", "../assets/RELEASES-NOTES.md", "../assets/ROADMAP.md"]
        }
    ]
...
def compile():
    ...
    releases_filepath = os.path.join(root_dir, 'assets', 'RELEASES-NOTES.md')
    current_release_filepath = os.path.join(root_dir, 'CURRENT-RELEASE.md')
    roadmap_filepath = os.path.join(root_dir, 'assets', 'ROADMAP.md')
