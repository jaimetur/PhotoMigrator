...
#### 🔍 1. Pre Checks steps
  ...
  - 🗃️ 1.2. Create a backup of your original Takeout if needed.  
...
`(default=enabled. Can be disabled using flag '-gSkipPrep; --google-skip-preprocess')`
  ...
  - ✂️ 2.3. Fix Truncations on sidecar JSON names and media files to complete truncated suffixes or extensions when the filename length is high. 
#### 🧠 3. Process steps 
...
#### ✅ 4. Post Process steps
  - ➡️ 4.1. <span style="color:grey">Copy/Move files to Output folder manually. `(default=disabled. It is automatically enabled if detect that Step 3 has been skipped)`</span>
