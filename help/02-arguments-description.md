...
| `-useImmichDupDet`,<br>`--use-immich-duplicates-detection` | `<true\|false>`                          |       boolean     | `(default: true)`                            | Immich `Remove Duplicate Assets` only. Uses Immich's native visual duplicate detector; disable it to use PhotoMigrator's exact filename-and-size grouping.                                                                                                                                                                                                                                                                  |
