...
- **IMMICH_API_KEY_ADMIN:** The API_KEY for the Immich Administrator Account (Optional: reserved for administrator-only operations and future advanced maintenance features.)
