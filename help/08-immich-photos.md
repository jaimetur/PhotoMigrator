...
- **Explanation:**
  ...
  - On Immich, this flag also normalizes new destination album names to the preferred clean keeper even when the target has no prior similar variant, consolidates redundant variants into that keeper, and removes the old variants after the merge is confirmed.
- **Example of use:**
  ```
