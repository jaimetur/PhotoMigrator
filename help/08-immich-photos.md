...
- **Explanation:**
  ...
  - The merge and deletion method is selected by _**`--dup-immich-native-deletion`**_:
    ...
    | `false`                                | PhotoMigrator manually merges album memberships, tags, favorite state, highest rating, combined descriptions, most restrictive visibility, matching locations, and missing capture date. It also reconstructs affected stacks. | Permanently deleted after the remaining guarded merges succeed. |
- **Examples:**
  ```
