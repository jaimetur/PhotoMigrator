...
- **Linux/macOS:**
    ```bash
    curl -L -o PhotoMigrator_v3.3.3-alpha_docker.zip https://github.com/jaimetur/PhotoMigrator/releases/download/v3.3.3-alpha/PhotoMigrator_v3.3.3-alpha_docker.zip
    ```
  
- **Windows (PoowerShell):**
    ```bash
    curl.exe -L -o PhotoMigrator_v3.3.3-alpha_docker.zip https://github.com/jaimetur/PhotoMigrator/releases/download/v3.3.3-alpha/PhotoMigrator_v3.3.3-alpha_docker.zip
    ```
...
- **Linux/macOS:**
    ...
    7z x PhotoMigrator_v3.3.3-alpha_docker.zip
    cd PhotoMigrator/docker
    ```

- **Windows (PoowerShell):**
    ```bash
    powershell -Command "Expand-Archive -Path PhotoMigrator_v3.3.3-alpha_docker.zip -DestinationPath ./"
    cd PhotoMigrator\docker
    ```
