...
- **Linux/macOS:**
    ```bash
    curl -L -o PhotoMigrator_v3.8.0_docker.zip https://github.com/jaimetur/PhotoMigrator/releases/download/v3.8.0/PhotoMigrator_v3.8.0_docker.zip
    ```
  
- **Windows (PowerShell):**
    ```bash
    curl.exe -L -o PhotoMigrator_v3.8.0_docker.zip https://github.com/jaimetur/PhotoMigrator/releases/download/v3.8.0/PhotoMigrator_v3.8.0_docker.zip
    ```
...
- **Linux/macOS:**
    ...
    7z x PhotoMigrator_v3.8.0_docker.zip
    cd PhotoMigrator/docker
    ```

- **Windows (PowerShell):**
    ```bash
    powershell -Command "Expand-Archive -Path PhotoMigrator_v3.8.0_docker.zip -DestinationPath ./"
    cd PhotoMigrator\docker
    ```
