...
- **Linux/macOS:**
    ```bash
    curl -L -o PhotoMigrator_v3.7.0_docker.zip https://github.com/jaimetur/PhotoMigrator/releases/download/v3.7.0/PhotoMigrator_v3.7.0_docker.zip
    ```
  
- **Windows (PowerShell):**
    ```bash
    curl.exe -L -o PhotoMigrator_v3.7.0_docker.zip https://github.com/jaimetur/PhotoMigrator/releases/download/v3.7.0/PhotoMigrator_v3.7.0_docker.zip
    ```
