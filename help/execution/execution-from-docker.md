...
- **Linux/macOS:**
    ```bash
    curl -L -o PhotoMigrator_vPush_Queue3.4.4-alpha_docker.zip https://github.com/jaimetur/PhotoMigrator/releases/download/vPush_Queue3.4.4-alpha/PhotoMigrator_vPush_Queue3.4.4-alpha_docker.zip
    ```
  
- **Windows (PowerShell):**
    ```bash
    curl.exe -L -o PhotoMigrator_vPush_Queue3.4.4-alpha_docker.zip https://github.com/jaimetur/PhotoMigrator/releases/download/vPush_Queue3.4.4-alpha/PhotoMigrator_vPush_Queue3.4.4-alpha_docker.zip
    ```
...
- **Linux/macOS:**
    ...
    7z x PhotoMigrator_vPush_Queue3.4.4-alpha_docker.zip
    cd PhotoMigrator/docker
    ```

- **Windows (PowerShell):**
    ```bash
    powershell -Command "Expand-Archive -Path PhotoMigrator_vPush_Queue3.4.4-alpha_docker.zip -DestinationPath ./"
    cd PhotoMigrator\docker
    ```
