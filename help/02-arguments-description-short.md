...
| `-immichDupDel`,<br>`--immich-duplicates-deletion`   | Immich only: use Immich's Alpha resolver and move redundant assets to trash; off uses PhotoMigrator's guarded deletion (default: `false`) |
