...
| `-immichDupAlgo`,<br>`--duplicates-immich-native-algorithm` | Immich only: similarity detection; disable for exact filename/size Takeout re-upload checks (default: `true`)                                                                                                                                                                                                                                                                 |
...
| `-dupKeeper`,<br>`--duplicates-asset-keeper`          | Keeper: `more-people/tags-then-better-quality`, `more-people/tags-then-oldest`, `more-people/tags-then-newest`, `better-quality`, `oldest`, or `newest`. Immich defaults to `better-quality` with native detection and `more-people/tags-then-newest` without it. |
