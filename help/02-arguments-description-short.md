...
| `-dupKeeper`,<br>`--duplicate-asset-keeper`          | Keeper: `more-people/tags-then-better-quality`, `more-people/tags-then-oldest`, `more-people/tags-then-newest`, `better-quality`, `oldest`, or `newest`. Immich defaults to `better-quality` with native detection and `more-people/tags-then-newest` without it. |
