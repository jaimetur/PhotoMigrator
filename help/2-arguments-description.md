...
| `-fnExiftool`,<br>`--foldername-exiftool-output`   | `<EXIFTOOL_OUTPUT_FOLDER>`   |   path   |        `any folder name` (default: `Exiftool_outputs`)         | Specify the folder name to save the outputs of 'Exiftool' Metadata Fixer.                          |
