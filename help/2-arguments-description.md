...
| `-fnExtDates`,<br>`--foldername-extracted_dates`   | `<EXTRACTED_DATES_FOLDER>`   |   path   |        `any folder name` (default: `Extracted_Dates`)          | Specify the folder name to save the Metadata outputs of 'Extracted Dates'.                         |
