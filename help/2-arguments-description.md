...
| `-fnExtDates`,<br>`--foldername-extracted_dates`   | `<EXTRACTED_DATES_FOLDER>`   |   path   |        `any folder name` (default: `Exiftool_outputs`)         | Specify the folder name to save the Metadata outputs of 'Extracted Dates'.                         |
