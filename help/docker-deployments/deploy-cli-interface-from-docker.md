...
- [`PhotoMigrator_v4.3.2_docker.zip`](https://github.com/jaimetur/PhotoMigrator/releases/download/v4.3.2/PhotoMigrator_v4.3.2_docker.zip)

- **Linux/macOS**
  ```bash
  curl -L -o PhotoMigrator_v4.3.2_docker.zip https://github.com/jaimetur/PhotoMigrator/releases/download/v4.3.2/PhotoMigrator_v4.3.2_docker.zip
  ```

- **Windows (PowerShell)**
  ```bash
  curl.exe -L -o PhotoMigrator_v4.3.2_docker.zip https://github.com/jaimetur/PhotoMigrator/releases/download/v4.3.2/PhotoMigrator_v4.3.2_docker.zip
  ```
...
- **Linux/macOS**
  ```bash
  7z x PhotoMigrator_v4.3.2_docker.zip
  cd PhotoMigrator/docker-cli
  ```

- **Windows (PowerShell)**
  ```bash
  powershell -Command "Expand-Archive -Path PhotoMigrator_v4.3.2_docker.zip -DestinationPath ./"
  cd PhotoMigrator\docker-cli
  ```
...
- Specific version
  ```bash
  docker pull jaimetur/photomigrator-linux:4.3.2
  ```
