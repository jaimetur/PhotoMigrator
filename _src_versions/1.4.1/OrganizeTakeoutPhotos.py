...
def main():
    ...
    # Detect Find Duplicates Mode:
    if args.find_duplicates_in_folders!="" or args.duplicates_action!="":
        if args.find_duplicates_in_folders!="" and  args.duplicates_action=="":
            logger.error(f"ERROR: Find Duplicates Mode detected with the argument '{args.find_duplicates_in_folders}' but not argument '-da, --duplicates-action' given. Exiting...")
            logger.info("")
            return -1
            ...
            logger.info(f"INFO: Find Duplicates Mode detected with those arguments:")
            ...
            duplicates_files_found = Utils.FindDuplicates(args.duplicates_action, args.find_duplicates_in_folders)
    ...
    # If not Find Duplicates Mode detected, we run the normal Scripts Steps
    else:
