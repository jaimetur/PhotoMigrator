...
def detect_and_execute():
    ...
    if current_os == "Linux":
        script_path = r'/mnt/dev/PycharmProjects/OrganizeTakeoutPhotos/src'
        script_name = "compile_python_linux.sh"
    elif current_os == "Darwin":
        script_path = r'/mnt/dev/PycharmProjects/OrganizeTakeoutPhotos/src'
        script_name = "compile_python_macos.sh"
    elif current_os == "Windows":
        script_path = r'c:\_RAIZ\Dev\Python_Scripts\Python Scripts - Jaime Tur\PycharmProjects\OrganizeTakeoutPhotos\src'
