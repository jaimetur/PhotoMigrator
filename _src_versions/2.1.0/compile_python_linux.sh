...
SCRIPT_ZIP_FILE="../_built_versions/${SCRIPT_NAME_VERSION}_${PLATTFORM}.zip"
...
pyinstaller --runtime-tmpdir /var/tmp --onefile --hidden-import os,sys,tqdm,argparse,platform,shutil,re,textwrap,logging,collections,csv,time,datetime,hashlib,fnmatch,requests,urllib3 --add-data "../gpth_tool_"$PLATTFORM":gpth_tool" --add-data "../exif_tool_"$PLATTFORM":exif_tool" $SCRIPT_ORIGINAL
