...
set "SCRIPT_ZIP_FILE=.\built_versions\%SCRIPT_NAME_VERSION%_%PLATTFORM%.zip"
...
set COMMAND=--onefile --add-data gpth_tool_%PLATTFORM%;gpth_tool --add-data exif_tool_%PLATTFORM%;exif_tool %SCRIPT_ORIGINAL%
...
REM Move compiled executable
move "%SCRIPT_COMPILED%" "..\data\%SCRIPT_COMPILED%" >nul
