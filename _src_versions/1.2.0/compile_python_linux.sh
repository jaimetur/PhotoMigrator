...
pyinstaller --onefile --add-data "gpth_tool_"$PLATTFORM":gpth_tool" --add-data "exif_tool_"$PLATTFORM":exif_tool" $SCRIPT_ORIGINAL
mv ./dist/$SCRIPT_NAME ./$SCRIPT_COMPILED
...
# Movemos el script compilado a la carpeta raiz.
