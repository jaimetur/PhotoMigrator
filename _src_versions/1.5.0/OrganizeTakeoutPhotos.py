...
DEPRIORITIZE_FOLDERS_PATTERNS = ["*Photos from [1-2][0-9][0-9][0-9]*", "*ALL_PHOTOS*", "*Variad[oa]*", "*Vari[oa]*", "*Miscellaneous*", "*Fotos *", "*Fotos de*", "*Fotos con*"]
...
def main():
    ...
    if args.find_duplicates_in_folders=="" and args.duplicates_action=="" and args.fix_symlinks_broken=="":
    ...
    # If Detect Find Duplicates Mode:
        ...
        logger.info(f"INFO: Find Duplicates Mode detected :")
