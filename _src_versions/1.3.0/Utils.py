...
def fix_metadata_with_gpth_tool(input_folder, output_folder, flatten_albums=True,
skip_extras=False, flatten_no_albums=False, move_takeout_folder=False, ignore_takeout_structure=False):
